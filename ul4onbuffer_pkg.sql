...
as
	...
	`ul4onbuffer_pkg` can be used for creating UL4ON dumps iteratively. For example
	creating an UL4ON dump of a list with two strings can be done like this::
		...
		begin
			...
			ul4onbuffer_pkg.beginlist(c_out);
				ul4onbuffer_pkg.str(c_out, 'foo');
				ul4onbuffer_pkg.str(c_out, 'bar');
			ul4onbuffer_pkg.endlist(c_out);
